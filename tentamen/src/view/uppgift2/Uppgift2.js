...
const [stateValue, setStateValue] = useState("Initialvärde")

	return (
		<div>
			<h1>Uppgift 2</h1>
			<h2>{stateValue}</h2>
			<input placeholder="Denna input skall uppdatera värdet som matas in till ditt state" onChange={event => setStateValue(event.target.value)} />
		</div>
	)
}
